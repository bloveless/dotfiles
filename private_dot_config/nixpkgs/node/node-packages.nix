...
let
  sources = {
    ...
    "@serverless/utils-6.11.1" = {
      ...
      version = "6.11.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@serverless/utils/-/utils-6.11.1.tgz";
    ...
    "aws-sdk-2.1392.0" = {
      ...
      version = "2.1392.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/aws-sdk/-/aws-sdk-2.1392.0.tgz";
        sha512 = "WWY3S4wyBzt+pkRcQ7il/wW6FvFvlkkXBXY34ZvuWd91fvI0ovuq1tmqq4eVlvLacblzUkGHgq7TejwpU67OIg==";
      };
    };
    "axios-0.21.4" = {
      name = "axios";
    ...
    "filesize-10.0.7" = {
      ...
      version = "10.0.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/filesize/-/filesize-10.0.7.tgz";
    ...
    "simple-git-3.19.0" = {
      ...
      version = "3.19.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/simple-git/-/simple-git-3.19.0.tgz";
        sha512 = "hyH2p9Ptxjf/xPuL7HfXbpYt9gKhC1yWDh3KYIAYJJePAKV7AEjLN4xhp7lozOdNiaJ9jlVvAbBymVlcS2jRiA==";
      };
    };
    "slash-3.0.0" = {
      name = "slash";
...
in
{
  serverless = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      (sources."@serverless/utils-6.11.1" // {
        dependencies = [
